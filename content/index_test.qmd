...
```
### Ocean sound monitoring within SBNMS 
```{python}
#| echo: false
display(HTML(standardTextDict["SB"]))
```
...
display(HTML(makeButtons("table_***_AISabove.jpg", "TimeSeries")))
infoHtml = f'''
            ...
            <dialog id ="infoModal3">
                <p> </p>
                {makeButtons("plot_***_AISTimeSeries.jpg", "MonthTable")}
