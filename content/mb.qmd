...
display(HTML(gf.makeImage("MBNMS_HumpbackWhaleDetections.jpg", "time series humpback")))
display(HTML(gf.makeButtons(sites, "plot_***HumpbackWhaleDetections.jpg", "seasonal humpback")))
```
