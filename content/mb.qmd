...
display(HTML(gf.makeImage("MB01_FinalHist.png", " Seasonal Fish Choruses")))
display(HTML(gf.makeImage("MB01_FinalRosePlot.png", " Daily Fish Choruses")))
```
### When are the seasonal biologically-important times for whales?
```{python}
#| echo: false
display(HTML(standardTextDict["MARS-whales"]))
display(HTML(gf.makeImage("MARS_BlueFinCI.jpg", "Seasonal blue and fin")))

display(HTML(standardTextDict["humpback-whales"]))
display(HTML(gf.makeImage("MBNMS_HumpbackWhaleDetections.jpeg", "time series humpback")))

display(HTML(standardTextDict["humpback-whales-boxplots"]))
display(HTML(gf.makeButtons(humpbacksites, "plot_***HumpbackWhaleDetections.jpeg", "seasonal_humpback"))) 
```
