...
display(HTML(gf.makeButtons(sites, "plot_***-63_status.jpg", "FOI")))
display(HTML(gf.makeButtons(sites, "plot_***-125_status.jpg", "FOI2")))
```
:::
...
display(HTML(gf.makeButtons(sitesIn, "plot_***_AISMonthAbove.jpg", "SoundLevelVariance")))
infoHtml3 = f'''
        <button style="background-color: #FFFFFF;" onclick="document.getElementById(&#39;infoModal3&#39;).showModal()">Table of Results</button>
            <dialog id="infoModal3">
                {gf.makeButtons(sitesIn, "table_***_AISMonthAbove.jpg", "AISMonthlyTables")}
...
display(HTML(gf.makeButtons(sitesIn, "plot_***_AIShist.jpg", "Histogram")))
infoHtml4 = f'''
        <button style="background-color: #FFFFFF;" onclick="document.getElementById(&#39;infoModal4&#39;).showModal()">Table of Results</button>
            <dialog id="infoModal4">
                {gf.makeButtons(sitesIn, "table_***_AIShist.jpg", "AISHistTables")}
