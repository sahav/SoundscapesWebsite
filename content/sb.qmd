...
### What proportion of time do soundscape conditions suggest the presence of ecologically or management-relevant sources (e.g., vocalizing species or vessel activity) ?
```{python}
#| echo: false
...
### Is noise from large vessels above typical conditions?
```{python}
#| echo: false
#display(HTML(standardTextDict[""]))
#display(HTML(gf.makeButtons(sites, "plot_***_125Hz.jpg", "SoundLevelVariance"))) 
display(HTML(gf.makeButtons(sites, "plot_***_LgVesselNoise125.jpg", "SoundLevelVariance"))) #LgVesselNoise125
#display(HTML(gf.addPlotly("plot_sb01_TS125ptly.html"))) # interactive version
```
