...
display(HTML(gf.makeButtons("plot_***_YearSPL.jpg", "YearSPL")))
```
:::
...
display(HTML(gf.makeButtons("plot_***_SeasonalSPL.jpg", "Seasons")))
infoHtml = f'''
...
display(HTML(gf.makeButtons("plot_***_Exceed100.jpg", "Freq")))
infoHtml = f'''
<button style="background-color: #FFFFFF;" onclick="document.getElementById(&#39;infoModal3&#39;).showModal()">
  ...
  {gf.makeButtons("table_***_AboveWind.jpg", "MonthTable")}
...
display(HTML(gf.makeButtons("plot_***_125Hz.jpg", "SoundLevelVariance")))
display(HTML(f"""
            <iframe
...
display(HTML(gf.makeButtons("plot_***_AIShist.jpg", "Histogram")))
```
