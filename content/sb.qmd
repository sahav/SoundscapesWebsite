...
infoHtml = f'''
            ...
            <dialog id="infoModal2">
                ...
                {gf.makeImage("plot_SB01_compare.jpg")}
...
# NEED TO ADD BUTTON: "Table of Results" table_***_AISMonthAbove.jpg
=======
display(HTML(gf.makeButtons(sites, "plot_***_AISMonthAbove.jpg", "SoundLevelVariance")))
infoHtml = f'''
        <button style="background-color: #FFFFFF;" onclick="document.getElementById(&#39;infoModal&#39;).showModal()">Table of Results</button>
            <dialog id="infoModal">
                {gf.makeButtons(sites, "table_***_AISMonthAbove.jpg", "AISMonthlyTables)}
                <button style="background-color: #FFFFFF;" onclick="document.getElementById(&#39;infoModal&#39;).close()">
                    Close
                </button>
            </dialog>
...
>>>>>>> 635326f (Added more buttons in sb)
```
...
<<<<<<< HEAD
# NEED TO ADD BUTTON: "Table of Results" table_***_AIShist.jpg
=======
infoHtml = f'''
        <button style="background-color: #FFFFFF;" onclick="document.getElementById(&#39;infoModal&#39;).showModal()">Table of Results</button>
            <dialog id="infoModal">
                {gf.makeButtons(sites, "table_***_AIShist.jpg", "AISMonthlyTables)}
                <button style="background-color: #FFFFFF;" onclick="document.getElementById(&#39;infoModal&#39;).close()">
                    Close
                </button>
            </dialog>
