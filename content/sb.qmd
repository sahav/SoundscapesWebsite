...
def embedMapViewer():
    return f'<embed src="https://apps-nefsc.fisheries.noaa.gov/pacm/" style="width:900px; height: 800px;">'
...
#df1 = pd.read_excel(metaFile, sheet_name="SB", dtype={"Start Date": str})
...
```{python}
#| echo: false
display(HTML(standardTextDict["When are North Atlantic Right whales detected in the soundscape?"]))
