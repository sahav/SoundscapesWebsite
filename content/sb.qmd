...
display(HTML(gf.makeButtons(sites, "plot_***_Exceed100.jpg", "Freq")))
infoHtml = f'''
<button style="background-color: #FFFFFF;" onclick="document.getElementById(&#39;infoModal3&#39;).showModal()">
  ...
  {gf.makeButtons(sites, "table_***_AboveWind.jpg", "MonthTable")}
...
display(HTML(gf.makeButtons(sites, "plot_***_125Hz.jpg", "SoundLevelVariance")))
display(HTML(gf.addPlotly("plot_sb01_TS125ptly.html")))
```
