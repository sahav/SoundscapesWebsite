...
display(HTML(gf.makeButtons("OC02", "plot_OC02_AISMonthAbove.jpg", "SoundLevelVariance"))) 
# NEED TO ADD BUTTON: "See Table Results" table_***_AISMonthAbove.jpg
display(HTML(gf.makeButtons("See Table Results", "table_OC02_AISMonthAbove.jpg", "AISMonthAboveTbl")))
```
