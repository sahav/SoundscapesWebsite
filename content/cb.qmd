...
headerSizes = ["100","200","200","200","200","200","200","100","100","150","100"]
tableWidth = sum(int(x) for x in headerSizes)
htmlTable = '<div>' + tabulate(summaryTable, tablefmt="unsafehtml") + '</div>'
htmlTable = htmlTable.replace('<table>', f'<table style="width:{tableWidth}px ;overflow-x: auto; display: block;">')
