...
```
### Summary of ONMS Sound data available through NCEI Passive Acoustic Data Archive <a href="https://console.cloud.google.com/storage/browser/noaa-passive-bioacoustic?invt=AbwKlA"  target="_blank">Google Cloud Platform</a>  
```{python}
#| echo: false
