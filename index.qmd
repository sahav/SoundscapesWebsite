...
display(HTML('<img src="MBNMS.jpg" alt="MarineLife" width="600">'))
```
:::
...
display(HTML(makeButtons("gantt_ONMS.jpg", "Gantt")))
display(HTML(makeButtons("map_ONMS_2024-11-05.jpg", "Map")))
...
display(HTML(makeButtons("plot_sb01_SeasonalSPL.jpg", "Seasons")))
```
:::
